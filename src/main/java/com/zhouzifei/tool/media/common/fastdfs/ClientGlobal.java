...
import com.zhouzifei.tool.media.common.fastdfs.common.IniFileReader;
...
public class ClientGlobal {
   ...
   *                      server之间用逗号','分隔
   */
  public static void initByProperties(String propsFilePath) throws IOException, ServiceException {
  ...
  public static void initByProperties(Properties props) throws IOException, ServiceException {
    ...
    if (trackerServersConf == null || trackerServersConf.trim().length() == 0) {
      throw new ServiceException(String.format("configure item %s is required", PROP_KEY_TRACKER_SERVERS));
    }
   ...
   *                       server之间用逗号','分隔
   */
  public static void initByTrackers(String trackerServers) throws IOException, ServiceException {
  ...
  public static void initByTrackers(InetSocketAddress[] trackerAddresses) throws IOException, ServiceException {
