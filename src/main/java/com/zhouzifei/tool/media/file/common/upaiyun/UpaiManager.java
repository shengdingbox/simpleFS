package com.zhouzifei.tool.media.file.common.upaiyun;
...
public class UpaiManager {
     ...
     * @return UpYun object
     */
    public UpaiManager(String bucketName, String userName, String password) {
     ...
     * @return response
     */
    public Response writeFile(String filePath, byte[] data, Map<String, String> params) throws IOException, ServiceException {
     ...
     * @throws IOException
     */
    public Response writeFile(String filePath, File file, Map<String, String> params) throws IOException, ServiceException {
     ...
     * @throws IOException
     */
    public Response writeFile(String filePath, InputStream inputStream, Map<String, String> params) throws IOException, ServiceException {
     ...
     */
    public Response copyFile(String path, String sourcePath, Map<String, String> params) throws IOException, ServiceException {
        if (params == null) {
     ...
     * @throws ServiceException
     */
    public Response moveFile(String path, String sourcePath, Map<String, String> params) throws IOException, ServiceException {
        if (params == null) {
            params = new HashMap<String, String>();
        }
        params.put(PARAMS.X_UPYUN_COPY_SOURCE.getValue(), sourcePath);
     ...
     * @return 文件内容 或 null
     */
    public Response readFile(String filePath) throws IOException, ServiceException {
     ...
     * @return response
     */
    public Response deleteFile(String filePath, Map<String, String> params) throws IOException, ServiceException {
     ...
     * @return response
     */
    public Response mkDir(String filePath) throws IOException, ServiceException {
     ...
     * @return response
     */
    public Response rmDir(String filePath) throws IOException, ServiceException {
     ...
     * @return 文件信息 或 null
     */
    public Response getFileInfo(String filePath) throws IOException, ServiceException {
     ...
     * @return response
     */
    public Response readDirIter(String path, Map<String, String> params) throws IOException, ServiceException {
     ...
     * @return response
     */
    public Response getBucketUsage() throws IOException, ServiceException {
    ...
    private Response request(String method, String filePath, RequestBody body, Map<String, String> params) throws ServiceException, IOException {
