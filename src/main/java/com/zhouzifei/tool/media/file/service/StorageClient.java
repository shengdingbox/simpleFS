...
import com.zhouzifei.tool.config.common.ProtoCommon;
import com.zhouzifei.tool.config.pool.ClientGlobal;
import com.zhouzifei.tool.config.pool.Connection;
import com.zhouzifei.tool.dto.FileInfo;
import com.zhouzifei.tool.dto.NameValuePair;
import com.zhouzifei.tool.exception.ServiceException;
import com.zhouzifei.tool.media.file.listener.DownloadCallback;
import com.zhouzifei.tool.media.file.listener.UploadCallback;
import com.zhouzifei.tool.media.file.listener.UploadStream;
import com.zhouzifei.tool.util.Base64;
...
public class StorageClient {
    ...
    /**
     * 将文件上传到存储服务器（按文件名）*
     * * @param local_filename要上传的本地文件名
     * * @param file_ext_name文件的扩展名，不包括点号（。），为null则从本地文件名中提取扩展名* @param meta_list元信息array * @return 2个元素，如果成功则为字符串数组：<br> * <ul> <li>结果[0]：存储文件的组名</ li> </ ul> * <ul> <li>结果[ 1]：新创建的文件名</ li> </ ul>
     * return null if fail
     */
    public String[] upload_file(String local_filename, String file_ext_name,
                                NameValuePair[] meta_list) throws IOException, ServiceException {
    ...
    public String[] upload_file(String group_name, byte[] file_buff, int offset, int length,
                                String file_ext_name, NameValuePair[] meta_list) throws IOException, ServiceException {
    ...
    public String[] upload_file(String group_name, String master_filename, String prefix_name,
                                String local_filename, String file_ext_name, NameValuePair[] meta_list) throws IOException, ServiceException {
        if ((group_name == null || group_name.length() == 0) ||
                (master_filename == null || master_filename.length() == 0) ||
                (prefix_name == null)) {
            throw new ServiceException("invalid arguement");
        }
     ...
     */
    public String[] upload_file(String group_name, String master_filename, String prefix_name,
                                byte[] file_buff, String file_ext_name, NameValuePair[] meta_list) throws IOException, ServiceException {
        if ((group_name == null || group_name.length() == 0) ||
                (master_filename == null || master_filename.length() == 0) ||
                (prefix_name == null)) {
            throw new ServiceException("invalid arguement");
     ...
     */
    public int append_file(String group_name, String appender_filename, String local_filename) throws IOException, ServiceException {
        File f = new File(local_filename);
        FileInputStream fis = new FileInputStream(f);
     ...
     * @return 0 for success, != 0 for error (error no)
     */
    public int append_file(String group_name, String appender_filename, byte[] file_buff) throws IOException, ServiceException {
    ...
    public int append_file(String group_name, String appender_filename,
                           byte[] file_buff, int offset, int length) throws IOException, ServiceException {
     ...
     */
    public int append_file(String group_name, String appender_filename,
                           long file_size, UploadCallback callback) throws IOException, ServiceException {
    ...
    public int modify_file(String group_name, String appender_filename,
                           long file_offset, String local_filename) throws IOException, ServiceException {
        File f = new File(local_filename);
        FileInputStream fis = new FileInputStream(f);
     ...
     */
    public int modify_file(String group_name, String appender_filename,
                           long file_offset, byte[] file_buff) throws IOException, ServiceException {
        return this.do_modify_file(group_name, appender_filename, file_offset,
     ...
     */
    public int modify_file(String group_name, String appender_filename,
                           long file_offset, byte[] file_buff, int buffer_offset, int buffer_length) throws IOException, ServiceException {
        return this.do_modify_file(group_name, appender_filename, file_offset,
     ...
     */
    public int modify_file(String group_name, String appender_filename,
                           long file_offset, long modify_size, UploadCallback callback) throws IOException, ServiceException {
        return this.do_modify_file(group_name, appender_filename, file_offset,
     ...
     * @return 0 for success, none zero for fail (error code)
     */
    public int truncate_file(String group_name, String appender_filename) throws IOException, ServiceException {
    ...
    public int truncate_file(String group_name, String appender_filename,
                             long truncated_file_size) throws IOException, ServiceException {
        byte[] header;
        boolean bNewStorageServer;
        Connection connection = null;
        byte[] hexLenBytes;
     ...
     */
    public byte[] download_file(String group_name, String remote_filename) throws IOException, ServiceException {
     ...
     * @return file content/buff, return null if fail
     */
    public byte[] download_file(String group_name, String remote_filename, long file_offset, long download_bytes) throws IOException, ServiceException {
    ...
    public int download_file(String group_name, String remote_filename,
                             String local_filename) throws IOException, ServiceException {
        final long file_offset = 0;
        final long download_bytes = 0;
     ...
     */
    public int download_file(String group_name, String remote_filename,
                             DownloadCallback callback) throws IOException, ServiceException {
        final long file_offset = 0;
        final long download_bytes = 0;
        return this.download_file(group_name, remote_filename,
    ...
    public int set_metadata(String group_name, String remote_filename,
                            NameValuePair[] meta_list, byte op_flag) throws IOException, ServiceException {
        boolean bNewStorageServer = this.newUpdatableStorageConnection(group_name, remote_filename);
        Connection connection = this.storageServer.getConnection();
        try {
            byte[] header;
     ...
     */
    public FileInfo get_file_info(String group_name, String remote_filename) throws IOException, ServiceException {
     ...
     */
    protected boolean newWritableStorageConnection(String group_name) throws IOException, ServiceException {
        if (this.storageServer != null) {
            ...
            if (this.storageServer == null) {
                throw new ServiceException("getStoreStorage fail, errno code: " + tracker.getErrorCode());
            }
            return true;
        }
    }
     ...
     * @return true if create a new connection
     */
    protected boolean newReadableStorageConnection(String group_name, String remote_filename) throws IOException, ServiceException {
        if (this.storageServer != null) {
            return false;
        } else {
            TrackerClient tracker = new TrackerClient();
     ...
     * @return true if create a new connection
     */
    protected boolean newUpdatableStorageConnection(String group_name, String remote_filename) throws IOException, ServiceException {
        if (this.storageServer != null) {
            return false;
        } else {
            TrackerClient tracker = new TrackerClient();
