...
import com.zhouzifei.tool.config.pool.ServerInfo;
import com.zhouzifei.tool.consts.StructGroupStat;
import com.zhouzifei.tool.consts.StructStorageStat;
import com.zhouzifei.tool.exception.ServiceException;
import com.zhouzifei.tool.util.ProtoStructDecoder;
...
public class TrackerClient {
     ...
     */
    public StorageServer getStoreStorage(TrackerServer trackerServer) throws IOException, ServiceException {
    ...
    public StorageServer getFetchStorage(TrackerServer trackerServer,
                                         String groupName, String filename) throws IOException, ServiceException {
    ...
    protected ServerInfo[] getStorages(TrackerServer trackerServer,
                                       byte cmd, String groupName, String filename) throws IOException, ServiceException {
        byte[] header;
        byte[] bFileName;
        byte[] bGroupName;
        byte[] bs;
     ...
     * @return storage server Socket object, return null if fail
     */
    public StorageServer getFetchStorage1(TrackerServer trackerServer, String file_id) throws IOException, ServiceException {
     ...
     * @return storage servers, return null if fail
     */
    public ServerInfo[] getFetchStorages1(TrackerServer trackerServer, String file_id) throws IOException, ServiceException {
        String[] parts = new String[2];
        this.errno = StorageClient1.split_file_id(file_id, parts);
        if (this.errno != 0) {
            return null;
     ...
     */
    public StructStorageStat[] listStorages(TrackerServer trackerServer, String groupName) throws IOException, ServiceException {
    ...
    public StructStorageStat[] listStorages(TrackerServer trackerServer,
                                            String groupName, String storageIpAddr) throws IOException, ServiceException {
        byte[] header;
        byte[] bGroupName;
        byte[] bs;
        int len;
     ...
     * @return true for success, false for fail
     */
    public boolean deleteStorage(String groupName, String storageIpAddr) throws IOException, ServiceException {
