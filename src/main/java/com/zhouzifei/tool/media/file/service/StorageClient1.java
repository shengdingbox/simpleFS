...
public class StorageClient1 extends StorageClient {
   ...
   */
  public int append_file1(String appender_file_id, String local_filename) throws IOException, ServiceException {
    String[] parts = new String[2];
   ...
   * @return 0 for success, != 0 for error (error no)
   */
  public int append_file1(String appender_file_id, byte[] file_buff) throws IOException, ServiceException {
    String[] parts = new String[2];
    this.errno = this.split_file_id(appender_file_id, parts);
    if (this.errno != 0) {
      return this.errno;
   ...
   * @return 0 for success, != 0 for error (error no)
   */
  public int append_file1(String appender_file_id, byte[] file_buff, int offset, int length) throws IOException, ServiceException {
    String[] parts = new String[2];
    this.errno = this.split_file_id(appender_file_id, parts);
    if (this.errno != 0) {
      return this.errno;
   ...
   * @return 0 for success, != 0 for error (error no)
   */
  public int append_file1(String appender_file_id, long file_size, UploadCallback callback) throws IOException, ServiceException {
    String[] parts = new String[2];
    this.errno = this.split_file_id(appender_file_id, parts);
    if (this.errno != 0) {
      return this.errno;
   ...
   */
  public String regenerate_appender_filename1(String appender_file_id) throws IOException, ServiceException {
    String[] parts = new String[2];
    this.errno = this.split_file_id(appender_file_id, parts);
    if (this.errno != 0) {
      return null;
   ...
   */
  public int delete_file1(String file_id) throws IOException, ServiceException {
    String[] parts = new String[2];
   ...
   * @return 0 for success, none zero for fail (error code)
   */
  public int truncate_file1(String appender_file_id) throws IOException, ServiceException {
    String[] parts = new String[2];
    this.errno = this.split_file_id(appender_file_id, parts);
    if (this.errno != 0) {
      return this.errno;
   ...
   * @return 0 for success, none zero for fail (error code)
   */
  public int truncate_file1(String appender_file_id, long truncated_file_size) throws IOException, ServiceException {
    String[] parts = new String[2];
    this.errno = this.split_file_id(appender_file_id, parts);
    if (this.errno != 0) {
      return this.errno;
   ...
   */
  public byte[] download_file1(String file_id) throws IOException, ServiceException {
   ...
   */
  public byte[] download_file1(String file_id, long file_offset, long download_bytes) throws IOException, ServiceException {
    String[] parts = new String[2];
    this.errno = this.split_file_id(file_id, parts);
    if (this.errno != 0) {
      return null;
   ...
   */
  public int download_file1(String file_id, String local_filename) throws IOException, ServiceException {
    final long file_offset = 0;
    final long download_bytes = 0;
   ...
   * @return 0 success, return none zero errno if fail
   */
  public int download_file1(String file_id, long file_offset, long download_bytes, String local_filename) throws IOException, ServiceException {
    String[] parts = new String[2];
    this.errno = this.split_file_id(file_id, parts);
    if (this.errno != 0) {
      return this.errno;
   ...
   * @return 0 success, return none zero errno if fail
   */
  public int download_file1(String file_id, DownloadCallback callback) throws IOException, ServiceException {
    final long file_offset = 0;
    final long download_bytes = 0;
   ...
   * @return 0 success, return none zero errno if fail
   */
  public int download_file1(String file_id, long file_offset, long download_bytes, DownloadCallback callback) throws IOException, ServiceException {
    String[] parts = new String[2];
    this.errno = this.split_file_id(file_id, parts);
    if (this.errno != 0) {
      return this.errno;
   ...
   */
  public NameValuePair[] get_metadata1(String file_id) throws IOException, ServiceException {
    String[] parts = new String[2];
    this.errno = this.split_file_id(file_id, parts);
    if (this.errno != 0) {
      return null;
   ...
   */
  public int set_metadata1(String file_id, NameValuePair[] meta_list, byte op_flag) throws IOException, ServiceException {
    String[] parts = new String[2];
    this.errno = this.split_file_id(file_id, parts);
    if (this.errno != 0) {
      return this.errno;
   ...
   */
  public FileInfo query_file_info1(String file_id) throws IOException, ServiceException {
    String[] parts = new String[2];
    this.errno = this.split_file_id(file_id, parts);
    if (this.errno != 0) {
      return null;
   ...
   * @return FileInfo object for success, return null for fail
   */
  public FileInfo get_file_info1(String file_id) throws IOException, ServiceException {
    String[] parts = new String[2];
    this.errno = this.split_file_id(file_id, parts);
    if (this.errno != 0) {
      return null;
