...
public class ImageDownloadUtil {
     ...
     */
    public static String saveToCloudStorage(String imgUrl, String referer, String storageType) {
        log.debug("download img >> %s", imgUrl);
        String res = null;
        try (InputStream is = getInputStreamByUrl(imgUrl, referer)) {
            FileUploader uploader = new GlobalFileUploader();
            VirtualFile file = uploader.upload(is, FileUploadType.SIMPLE.getPath(), imgUrl,storageType);
