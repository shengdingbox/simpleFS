...
public class RedisUtils {
    ...
    public void setDatasource(int datasource) {
        ...
        factory.setDatabase(datasource);  //设置db
    ...
    public Set<String> keysGetKey(String keys) {
        try {
     ...
     * @return
     */
    public List<Object> keys(String keys) {
        try {
            Set<String> keySet = redisTemplate.keys(keys);
            List<Object> keysBean = new ArrayList<>();
            if (keySet != null) {
                keySet.forEach(key -> {
